// Começa com dois pois já temos uma linha na tabela
let proximoId = 2;

// Variável para saber qual o colaborador que estamos editando, se estiver com -1 no modo de cadastro
...
function adicionarCliquesBotoes() {
    ...
    for (let i = 0; i < apagarBotoes.length; i += 1) {
        ...
        botaoApagar.addEventListener("click", confimarParaApagar);
    }
}
...
function preencherCamposParaEditar(event) {
    ...
    // Salvar na variável global para que depois conseguimos editar o dado corretamente
    indexParaEditar = linha.rowIndex;
}

function confimarParaApagar(event) {
